...
//set collider for mainCyclist
  ...
  mainCyclist.setCollider("rectangle",0,0,mainCyclist.width = 50 ,mainCyclist.height = 50);
...
function reset(){
  ...
  gameState = PLAY;
  gameOver.visible = false;
  mainCyclist.addAnimation("Mainracer", mainRacerImg1);
  
  gameOver.visible = true;
    //Add code to show restart game instrution in text here
  text("press right arrow to reset", 200,200);
  gameOver.visible = true;
